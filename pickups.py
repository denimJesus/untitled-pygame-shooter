...
class Xp(pg.sprite.Sprite):
    ...
    colors = [(140, 70, 255), (200, 70, 230), (255, 180, 120), (180, 240, 0), (200, 200, 40), (255, 255, 100)]
    def __init__(self, game, pos_x, pos_y, xp_amount = 1):
        ...
        if xp_amount <= len(self.colors):
            self.surf.fill(self.colors[xp_amount-1])
        else:
            self.surf.fill(self.colors[-1])
